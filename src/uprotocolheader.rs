...
///
/// This header intentionally stores only placement facts for the selected-wire
/// metadata byte range and visible application payload. Wire identity, payload
/// family, and payload encoding remain inside the prepared metadata bytes.
#[repr(C)]
